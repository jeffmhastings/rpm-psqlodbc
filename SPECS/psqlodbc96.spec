...
Conflicts: postgresql-odbc postgresql96-odbc psqlodbc psqlodbc95
BuildRequires: automake autoconf libtool postgresql96-devel
...
%build
%configure --enable-pthreads --with-libpq=/usr/pgsql-9.6 --with-unixodbc=/usr/bin/odbc_config
make all
